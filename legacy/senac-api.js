...
/** Obtém o "category" Id da unidade a partir da "friendly URL" */
async function getCategoryIdUnidade(friendlyUrl) {
  const { data } = await api.get(
    `/o/senac-unidade-services/categoriaPorFriendlyURL/${friendlyUrl}/0`
  );
  //Garante que "data" que deveria conter o id da unidade não é nulo/undfined e que nao é um array vazio
...
/** Obtém o "category" Id do tipo de curso (ex: "Livre", "Técnico", "Extensão") */
