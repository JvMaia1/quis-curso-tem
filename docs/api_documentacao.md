...
Vocabulário "Área/Nome Mercadologico"
...
| `VOCABULARY_ID` | `40393` | ID do vocabulário "Área/Nome Mercadologico" |
...
Retorna todas as categorias do vocabulário "Área/Nome Mercadologico", usado para organizar os cursos (ex: "Administração", "Tecnologia", "Saúde").
...
| `vocabularyIds` | `40393` | ID do vocabulário "Área/Nome Mercadologico" |
